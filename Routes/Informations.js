...
RouteInformations.post("/addStrains", async (req,res) => {
  ...
  RouteInformations.post("/addLocations", async (req,res) => {
    const Name = req.body.Name;
  ...
  RouteInformations.post("/addGreenhouses", async (req,res) => {
  ...
  RouteInformations.post("/addPots", async (req,res) => {
  ...
  RouteInformations.post("/addCultivations", async (req,res) => {
    const GreenHouseID = req.body.GreenHouseID;
  ...
  RouteInformations.post("/addInventorys", async (req,res) => {
    const Name = req.body.Name;
  ...
  RouteInformations.post("/addChemicalUses", async (req,res) => {
